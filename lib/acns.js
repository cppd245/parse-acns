(function() {
  ...
  exports.Parser = (function(superClass) {
    ...
    Parser.prototype.extractXml = function(str) {
      ...
      var re = /(?:[A-Za-z0-9+\/]{4}\n?)*(?:[A-Za-z0-9+\/]{2}==|[A-Za-z0-9+\/]{3}=)?/g;
      var arrayOfBase64 = str.match(re);

      if (arrayOfBase64.length > 1 && arrayOfBase64.length < 10) {
        str = '';
        _(arrayOfBase64).each(function(part) {
          if (validator.isBase64(part)) {
            var b = new Buffer(part, 'base64');
            str += b.toString('utf8');
          }
        });
      }
